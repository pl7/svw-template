...
?>
<article itemscope itemtype="http://schema.org/Article" <?php if ($this->item->state == 0)  echo ' class="system-unpublished"'; ?>  class="<?php echo 'cat-'.$this->item->catid.' parent-'.$this->item->parent_id;?>" style="<? if($this->item->featured == 1) echo'display:none;'?>">
